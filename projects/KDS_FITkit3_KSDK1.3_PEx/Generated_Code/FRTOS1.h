...
**          Kinetis SDK                                    : KSDK1
**          Kinetis SDK                                    : Enabled
**            Generate PEX_RTOS Macros                     : no
**            Generate OSA Functions                       : no
...
#define FRTOS1_GENERATE_PEX_RTOS_MACROS      0  /* set to 1 to generate the RTOS macros PEX_RTOS_INIT() and PEX_RTOS_START() */
...
#define FRTOS1_xTaskGetCurrentTaskHandle() \
...
#define FRTOS1_xTaskGetIdleTaskHandle() \
...
#define FRTOS1_pcTaskGetTaskName(xTaskToQuery) \
...
#define FRTOS1_xQueueOverwrite(xQueue, pvItemToQueue) \
...
#define FRTOS1_xEventGroupCreate() \
  xEventGroupCreate()
/*
** ===================================================================
...
#define FRTOS1_xEventGroupWaitBits(xEventGroup, uxBitsToWaitFor, xClearOnExit, xWaitForAllBits, xTicksToWait) \
...
#define FRTOS1_xEventGroupSetBits(xEventGroup, uxBitsToSet) \
...
#define FRTOS1_xEventGroupSetBitsFromISR(xEventGroup, uxBitsToSet, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xEventGroupClearBits(xEventGroup, uxBitsToSet) \
...
#define FRTOS1_xEventGroupClearBitsFromISR(xEventGroup, uxBitsToSet) \
...
#define FRTOS1_xEventGroupGetBits(xEventGroup) \
...
#define FRTOS1_xEventGroupGetBitsFromISR(xEventGroup) \
...
#define FRTOS1_xEventGroupSync(xEventGroup, uxBitsToSet, uxBitsToWaitFor, xTicksToWait) \
...
#define FRTOS1_xTimerCreate(pcTimerName, xTimerPeriod, uxAutoReload, pvTimerID, pxCallbackFunction) \
...
#define FRTOS1_xTimerIsTimerActive(xTimer) \
...
#define FRTOS1_xTimerStart(xTimer, xBlockTime) \
...
#define FRTOS1_xTimerStop(xTimer, xBlockTime) \
...
#define FRTOS1_xTimerChangePeriod(xTimer, xNewPeriod, xBlockTime) \
...
#define FRTOS1_xTimerDelete(xTimer, xBlockTime) \
...
#define FRTOS1_xTimerReset(xTimer, xBlockTime) \
...
#define FRTOS1_xTimerStartFromISR(xTimer, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTimerStopFromISR(xTimer, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTimerChangePeriodFromISR(xTimer, xNewPeriod, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTimerResetFromISR(xTimer, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_pvTimerGetTimerID(xTimer) \
...
#define FRTOS1_xTimerGetTimerDaemonTaskHandle() \
...
#define FRTOS1_pcTimerGetTimerName(xTimer) \
...
#define FRTOS1_xTimerPendFunctionCall(xFunctionToPend, pvParameter1, ulParameter2, xTicksToWait) \
...
#define FRTOS1_xTimerPendFunctionCallFromISR(xFunctionToPend, pvParameter1, ulParameter2, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTaskNotifyGive(xTaskToNotify) \
...
#define FRTOS1_ulTaskNotifyTake(xClearCountOnExit, xTicksToWait) \
...
#define FRTOS1_vTaskNotifyGiveFromISR(xTaskToNotify, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTaskNotify(xTaskToNotify, ulValue, eAction) \
...
#define FRTOS1_xTaskNotifyFromISR(xTaskToNotify, ulValue, eAction, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTaskNotifyWait(ulBitsToClearOnEntry, ulBitsToClearOnExit, pulNotificationValue, xTicksToWait) \
...
#define FRTOS1_vTaskSetThreadLocalStoragePointer(xTaskToSet, xIndex, pvValue) \
...
#define FRTOS1_pvTaskGetThreadLocalStoragePointer(xTaskToQuery, xIndex) \
...
#define FRTOS1_xSemaphoreCreateBinary() \
...
#define FRTOS1_xTaskNotifyAndQuery(xTaskToNotify, ulValue, eAction, pulPreviousNotifyValue) \
...
#define FRTOS1_xTaskNotifyAndQueryFromISR(xTaskToNotify, ulValue, eAction, pulPreviousNotifyValue, pxHigherPriorityTaskWoken) \
...
#define FRTOS1_xTaskNotifyStateClear(xTask) \
...
#define FRTOS1_xTaskGetHandle(pcNameToQuery) \
...
#define FRTOS1_pcTaskGetName(xTaskToQuery) \
...
#define FRTOS1_xTaskCreateStatic(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, puxStackBuffer, pxTaskBuffer) \
...
#define FRTOS1_xQueueCreateStatic(uxQueueLength, uxItemSize, pucQueueStorageBuffer, pxQueueBuffer) \
...
#define FRTOS1_xEventGroupCreateStatic(pxEventGroupBuffer) \
...
#define FRTOS1_xSemaphoreCreateBinaryStatic(pxSemaphoreBuffer) \
...
#define FRTOS1_xSemaphoreCreateCountingStatic(uxMaxCount, uxInitialCount, pxSempahoreBuffer) \
...
#define FRTOS1_xSemaphoreCreateMutexStatic(pxMutexBuffer) \
...
#define FRTOS1_xTaskAbortDelay(xTask) \
...
#define FRTOS1_vTaskGetInfo(xTask, pxTaskStatus, xGetFreeStackSpace, eState) \
...
#define FRTOS1_uxSemaphoreGetCount(xSemaphore) \
...
#define FRTOS1_xSemaphoreCreateRecursiveMutexStatic(pxMutexBuffer) \
